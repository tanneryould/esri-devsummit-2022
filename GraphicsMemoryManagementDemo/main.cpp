...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("GraphicsMemoryManagementDemo - C++"));
  ...
  GraphicsMemoryManagementDemo::init();
  ...
  // Set the source
  engine.load(QUrl("qrc:/Samples/Analysis/GraphicsMemoryManagementDemo/main.qml"));
